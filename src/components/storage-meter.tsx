...
export async function StorageMeter() {
  // auth() vyhazuje, když request neprošel clerkMiddleware - stane se to u 404 stránek pro cesty vyloučené z proxy matcheru, protože i ty prochází root layoutem.
  // Bez session meter prostě není.
